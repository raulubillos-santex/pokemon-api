const {writeFileGetPokemon} = require('/../services/file');
const {writeFilePostPokemon} = require('/../services/file');
const {writeFilePutPokemon} = require('/../services/file');
const {writeFileDeletePokemon} = require('/../services/file');
